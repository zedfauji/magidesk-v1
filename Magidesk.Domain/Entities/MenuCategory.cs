...
public class MenuCategory
{
    ...
    // Efficiency: Hierarchical support
    public Guid? ParentCategoryId { get; private set; }
    public MenuCategory? ParentCategory { get; private set; }
    ...
    public void SetParent(MenuCategory? parent)
    {
        if (parent != null && parent.Id == Id)
            throw new Exceptions.BusinessRuleViolationException("A category cannot be its own parent.");
