...
/// <summary>
/// Handler for GetCashSessionQuery.
/// </summary>
public class GetCashSessionQueryHandler : IQueryHandler<GetCashSessionQuery, GetCashSessionResult>
{
    private readonly ICashSessionRepository _cashSessionRepository;

    public GetCashSessionQueryHandler(ICashSessionRepository cashSessionRepository)
    {
        _cashSessionRepository = cashSessionRepository;
    }

    public async Task<GetCashSessionResult> HandleAsync(GetCashSessionQuery query, CancellationToken cancellationToken = default)
    {
        var cashSession = await _cashSessionRepository.GetByIdAsync(query.CashSessionId, cancellationToken);
        
        return new GetCashSessionResult
        {
