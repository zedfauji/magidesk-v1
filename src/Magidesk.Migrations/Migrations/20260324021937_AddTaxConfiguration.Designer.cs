...
namespace Magidesk.Migrations.Migrations
{
    ...
    [Migration("20260324021937_AddTaxConfiguration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.Equipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.GameHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GameHistory", "magidesk");
                });
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.ModifierGroup", b =>
                {
                    ...
                    b.Property<decimal>("ExtraModifierPrice")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.OrderType", b =>
                {
                    ...
                    b.Property<string>("DefaultTerminalRole")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.ServerAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UnassignedAt");

                    b.HasIndex("SessionId", "UnassignedAt")
                        .HasDatabaseName("IX_ServerAssignments_SessionId_Active");

                    b.HasIndex("ServerId", "AssignedAt", "UnassignedAt")
                        .HasDatabaseName("IX_ServerAssignments_ServerId_DateRange");

                    b.ToTable("ServerAssignments", "magidesk");
                });
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.TaxConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Magidesk.Infrastructure.Repositories.OverrideAuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ManagerId", "Timestamp");

                    b.HasIndex("OverrideType", "Timestamp");

                    b.ToTable("OverrideAuditEntries", (string)null);
                });

            modelBuilder.Entity("Magidesk.Infrastructure.Repositories.SessionAuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SessionAuditEntries", "magidesk");
                });

            modelBuilder.Entity("Magidesk.Infrastructure.Services.AlertEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsActive", "Severity", "CreatedAt")
                        .HasDatabaseName("IX_Alerts_Active_Severity_Created");

                    b.ToTable("Alerts", "magidesk");
                });

            modelBuilder.Entity("Magidesk.Infrastructure.Services.PerformanceMetricEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PerformanceMetrics", "magidesk");
                });
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.GameHistory", b =>
                {
                    b.OwnsOne("Magidesk.Domain.ValueObjects.Money", "TotalCharge", b1 =>
                        {
                            b1.Property<Guid>("GameHistoryId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("GameHistoryId");

                            b1.ToTable("GameHistory", "magidesk");
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.MenuCategory", b =>
                {
                    b.HasOne("Magidesk.Domain.Entities.MenuCategory", "Parent")
            ...
            modelBuilder.Entity("Magidesk.Domain.Entities.Payment", b =>
                {
                    ...
                    b.OwnsOne("Magidesk.Domain.ValueObjects.Money", "RefundedAmount", b1 =>
                        {
                            b1.Property<Guid>("PaymentId")
                                .HasColumnType("uuid");
